...
export default function AdminUsers() {
  ...
  const load = async () => {
    ...
    const { data } = await q; setUsers(data || []); setLoading(false);
  };
      ...
      <div className="card !p-0">
        {loading ? <div className="p-6"><div className="skeleton h-40" /></div> : (
          <table className="w-full text-sm">
            <thead><tr className="border-b border-white/[0.06] text-left text-xs text-white/40"><th className="px-4 py-3">Name</th><th className="px-4 py-3">Email</th><th className="px-4 py-3">Role</th><th className="px-4 py-3">Status</th><th className="px-4 py-3"></th></tr></thead>
