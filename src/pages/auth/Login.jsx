      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <input
              required type="password" placeholder="Password" className="input-field"
              value={form.password} onChange={(e) => setForm({ ...form, password: e.target.value })}
            />
            <div className="flex justify-end">
              <Link to="/forgot-password" className="text-xs text-accent-400 hover:text-accent-300">Forgot password?</Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-white/50">
            New here? <Link to="/register" className="text-accent-400 hover:text-accent-300">Create an account</Link>
          </p>
        </div>
      </div>
    </div>
