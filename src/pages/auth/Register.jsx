      ...
      <div className="w-full max-w-md">
        ...
        <div className="card">
          ...
          <div className="mb-6 grid grid-cols-2 gap-3">
            <button
              ...
              className={`flex flex-col items-center gap-2 rounded-xl border p-4 transition ${
                role === 'candidate' ? 'border-accent-500 bg-accent-500/10' : 'border-white/10 hover:border-white/20'
              }`}
            >
              <UserRound size={20} />
            ...
            <button
              type="button" onClick={() => setRole('employer')}
              className={`flex flex-col items-center gap-2 rounded-xl border p-4 transition ${
                role === 'employer' ? 'border-accent-500 bg-accent-500/10' : 'border-white/10 hover:border-white/20'
              }`}
            >
              <Briefcase size={20} />
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            />
            <input
              required type="password" placeholder="Password (min. 8 characters)" className="input-field"
